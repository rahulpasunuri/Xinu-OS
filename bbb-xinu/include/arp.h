...
#define	ARP_CACHE_TIMEOUT	300		/* An ARP entry will only be in useful in cache for 5 mins. (300 secs)	*/
...
struct	arpentry {			/* Entry in the ARP cache	*/
	...
	uint32  entryTime; /* Time at which the ARP entry was added to the cache..*/
};
